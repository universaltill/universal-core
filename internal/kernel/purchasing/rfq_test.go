...
func TestRequestForQuotationEntitiesAreInAll(t *testing.T) {
	// RequestForQuotationLine and RequestForQuotationQuoteLine both moved
	// to Version 2, for changes developed in parallel: uc-infra#80 gave
	// qty and unit_price a Min:0 bound, and uc-infra#68 additionally
	// changed QuoteLine.unit_price's TYPE to FieldMoney. The other two
	// declared neither, so they stayed at the original Version 1.
