...
func TestReferencePicker_StatusIDOnlyOffersOwnStatusType(t *testing.T) {
	...
	// sales published too, and its own status_id picker never visited —
	// only its StatusType/Status rows need to exist, to give a real
	// wrong-StatusType candidate set for the narrowing to fail open into.
