...
// browser_discovery_test.go's browserMissingAction. Found 2026-08-02,
// via uc-infra#56's coverage-gate independent review: a coverage
// baseline measured on a machine with no browser silently skipped all
// 49 of this package's tests and would have gone uncaught the same way
// in CI if its ambient Chrome ever disappeared.
package e2e
